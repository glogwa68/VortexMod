...
package net.mcreator.vortexmod.block;
...
public class AnciantDebritBlock extends VortexmodModElements.ModElement {
	@ObjectHolder("vortexmod:anciant_debrit")
	public static final Block block = null;
	public AnciantDebritBlock(VortexmodModElements instance) {
		super(instance, 5);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("anciant_debrit");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blocks.ANCIENT_DEBRIS, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("vortexmod:netherite").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		...
		}, block.getDefaultState(), 4)).range(11).square().func_242731_b(32));
	}
}

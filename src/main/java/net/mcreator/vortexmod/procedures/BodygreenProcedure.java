...
public class BodygreenProcedure extends VortexmodModElements.ModElement {
	public BodygreenProcedure(VortexmodModElements instance) {
		super(instance, 9);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				VortexmodMod.LOGGER.warn("Failed to load dependency entity for procedure Bodygreen!");
			return;
		}

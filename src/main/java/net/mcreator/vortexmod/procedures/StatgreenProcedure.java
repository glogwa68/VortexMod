...
public class StatgreenProcedure extends VortexmodModElements.ModElement {
	public StatgreenProcedure(VortexmodModElements instance) {
		super(instance, 7);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				VortexmodMod.LOGGER.warn("Failed to load dependency entity for procedure Statgreen!");
			return;
		}

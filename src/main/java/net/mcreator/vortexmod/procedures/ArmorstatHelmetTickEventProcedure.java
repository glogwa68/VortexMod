...
public class ArmorstatHelmetTickEventProcedure extends VortexmodModElements.ModElement {
	public ArmorstatHelmetTickEventProcedure(VortexmodModElements instance) {
		super(instance, 8);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				VortexmodMod.LOGGER.warn("Failed to load dependency entity for procedure ArmorstatHelmetTickEvent!");
			return;
		}
